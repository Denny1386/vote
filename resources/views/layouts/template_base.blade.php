...
<head>
    ...
    <meta name="description" content="Регистрация на программы образовательного центра «Взлёт»">
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <title>Регистрация на программы образовательного центра «Взлёт»</title>

    <!-- Bootstrap Core CSS v.3.3.7-->
...
<script>
    <!-- Add crsf-token to all ajax requests -->
    $.ajaxSetup({
        headers: {
...
<script src="{{ asset('libs/jquery.maskedinput.min.js') }}"></script>
